      ...
      <section className="py-16 md:py-24">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 space-y-8 text-xs md:text-sm leading-relaxed text-gray-600">
          ...
          <div className="bg-amber-50 border border-amber-200 p-5 rounded-xl text-amber-950 flex items-start space-x-3.5">
            ...
            <div>
              <h2 className="font-bold text-amber-950 font-poppins mb-1 uppercase tracking-wide">
          ...
          <div className="space-y-6">
            <div className="space-y-2">
              <h2 className="text-base font-bold font-poppins text-navy uppercase tracking-wider">
            ...
            <div className="space-y-2">
              ...
              <ul className="list-disc pl-5 space-y-1.5 font-medium text-navy">
                ...
                <li>
                  <Link href="/compliance?tab=investor-charter" className="hover:text-gold transition-colors">Investor Charter and rights</Link>
                </li>
                <li>
                  <Link href="/compliance?tab=complaint-data" className="hover:text-gold transition-colors">Complaint Redressal and History</Link>
                </li>
              </ul>
            </div>
