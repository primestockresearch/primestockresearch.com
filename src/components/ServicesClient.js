        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-24">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 items-stretch pt-4">
            {plans.map((plan, i) => (
              ...
              >
                {plan.badge && (
                  <span className="absolute -top-3.5 left-1/2 -translate-x-1/2 bg-gold text-white text-[10px] uppercase font-extrabold tracking-widest px-4.5 py-1 rounded-full shadow-sm">
                    {plan.badge}
                  </span>
                )}
                ...
                <div className="space-y-6">
                  ...
                  <div>
                    ...
                    <span className="text-xs text-gray-600 block mt-0.5 font-semibold uppercase tracking-wider">
              ...
              {faqs.map((faq, i) => (
                <div key={i} className="flex space-x-3 bg-gray-50/50 p-5 rounded-lg border border-gray-100">
                  ...
                  <div className="space-y-1.5">
                    <h3 className="font-bold text-navy font-poppins text-base leading-snug">
                      {faq.q}
                    </h3>
